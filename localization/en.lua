...
L.TargetQuality = 'Display Condition'
...
L.MinAlertQuality = 'Minimum Upgrade Quality'
L.MinAlertQualityTip = 'Only pets of this quality and above will be considered upgrades.'
